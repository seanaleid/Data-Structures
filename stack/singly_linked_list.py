...
class LinkedList:
    ...
    def __init__(self):
        #reference ot the head of the list 
        self.head = None
    ...
    def add_to_tail(self, value):
        ...
        #we have a non-empty list, add the new node to the tail
            ...
            # set the list's tail reference tot eh new node
            self.tail = new_node
    ...
    def contains(self, value):
        ...
        while current:
            # return True if the current value we're lookins at matches our target value
            if current.get_value() == value:
                return True
            # update our current node to the current node's next node
            current = current.get_next()
            # if we've gotten here, then that target node isn't in our list
        return False
